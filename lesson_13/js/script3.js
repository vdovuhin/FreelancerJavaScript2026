...
*/
let countPriceDecrease = dataList.reduce((count, item) => item.price < item.old_price ? count + 1 : count, 0);
document.write(`Кількість товарів, у яких ціна зменшилась = ${countPriceDecrease}<br>`);
//========================================================================================================================================================
/*
    3) Товари, які доступні (sell_status:"available")
*/
let availableProducts = dataList.filter((el) => el.sell_status === "available");
...
*/
let newProductList = availableProducts.map(({ id, price, old_price, usd_price }) => ({ id, price, old_price, usd_price }));
