...
*/
const K = 5; // Кількість магазинів
const day = 7; // Кількість днів у тижні
function getProfitRandom(min, max) {
...
document.write(`відсортувати кожен тиждень за зростанням: ${sortedShops}</br>`);
