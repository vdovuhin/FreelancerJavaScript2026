...
*/
let lengthMay: number = 3;

function getRandomArray(a: number) {
  let arr: number[] = [];
  for (let i = 0; i < a; i++) {
...
function getPairs(arr: string[]): string[][][] {
  let allResults: string[][][] = [];
  function backtrackString(remaining: string[], currentPairs: string[][]) {
